...
{
    public class ProposalSkin : ISkin
    {
        ...
        private readonly string[] apps = { "Flirt", "Dining", "Kiss", "Hold Hands", "Like You",
            "XOXO", "Committed", "Love You", "Moving In", "Meet Parents", "Will you marry me?",
